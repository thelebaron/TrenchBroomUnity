...
TEST_CASE("convertToString")
{
  ...
  m_entityPropertyConfig: EntityPropertyConfig{defaultModelScaleExpression: nullopt, setDefaultProperties: 0, updateAnglePropertyAfterTransform: 1, generateUniqueEntityIds: 0, generateClassnameIndices: 0},
  m_mapFormat: Quake3,
